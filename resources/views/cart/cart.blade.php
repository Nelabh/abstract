...
<div class="row align-left-cart" style="padding-top:10px; padding-bottom:10px" >
  <div class="col-sm-12">
    <button type="button" class="my-cart" >MY CART(1)</button>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-9">
    ...
    <div class="row">
      <div class="col-sm-3">
        <img class="orientation" src="{{URL::asset('images/spoon.png')}}" class="img-responsive" alt="spoon" width="250" height="250">
      </div>

      <div class="col-sm-9 ">
        <div class="row text-color">
          <div class="col-sm-4">
            <p>PLASTIC DISPOSABLE SPOON</p>
          </div>
          <div class="col-sm-2">
            <p>Price</p>
          </div>
